...
namespace ConsoleAppWhile1
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             * de piezas a procesar y luego ingrese la longitud de cada perfil; sabiendo que
             * la pieza cuya longitud esté comprendida en el rango de 1,20 y 1,30 son aptas.
